...
trait InventoryTrait {
  ...
  /** Test if item from inventory is equipped
    ...
    */
  def isEquipped(item: ItemTrait): Boolean = {
  ...
  /** Get weapon equipped
    ...
    */
  def getWeaponEquipped: Option[ItemTrait] = {
  ...
  /** Get armor equipped
    ...
    */
  def getArmorEquipped(armorPart: ArmorPart): Option[ItemTrait] = {
  ...
  /** Get items equipped
    ...
    */
  def getItemsEquipped: Seq[ItemTrait] = {
  ...
  /** Check item can be equipped i.e. is an equipment and complies with slot requirements
    ...
    */
  def canBeEquipped(item: ItemTrait): Boolean
}
